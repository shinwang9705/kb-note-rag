/**
 * 内联 SVG 图标集（零依赖）。图标 stroke 使用 currentColor，随文字颜色自动变色。
 * 尺寸统一 24×24 viewBox，可通过 className 覆盖宽高。
 */
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  chat: (
    <>
      <path d="M21 11.5a8.5 8.5 0 0 1-8.5 8.5c-1.2 0-2.4-.3-3.4-.7L4 20l.7-3.1A8.5 8.5 0 1 1 21 11.5z" />
  ...
  cockpit: (
    <>
      ...
      <path d="M3 9h18M6.5 6.5h.01M9.5 6.5h.01M12.5 6.5h.01M15.5 6.5h.01" />
    </>
  ),
};
